...
from projects.ScanVLA_COCOSearch18_ZeroGaze.models.mllm.qwen3vl import Qwen3VL

from projects.ScanVLA_COCOSearch18_ZeroGaze.models import ScanVLAModel, DirectResize

from projects.ScanVLA_COCOSearch18_ZeroGaze.datasets import COCOSearch18Dataset, scanvla_collect_fn_COCOSearch18

from projects.ScanVLA_COCOSearch18_ZeroGaze.models.ScanVLA_decoder_COCOSearch18 import TransformerDecoderWrapper
...
max_predict_lens = 7 # 单个类别可以预测的最大长度
condition = "present"
is_zerogaze = True
task = "car"
...
model = dict(
    ...
    condition=condition,
    max_predict_lens=max_predict_lens,
)
...
COCOSearch18_gaze_dataset=dict(
    type=COCOSearch18Dataset,
    name='COCOSearch18Dataset', #1
    fixs= DATA_ROOT_Gaze + train_refgazes,
    img_dir= DATA_ROOT_Gaze + img_dir,
    num_classes_per_sample=1,
    repeats=1,
    max_lm_lens=max_predict_lens,
    condition=condition,
    zerogaze = is_zerogaze,
    task = task,
...
train_dataloader = dict(
    ...
    dataset=COCOSearch18_gaze_dataset,
    sampler=dict(
        type=LengthGroupedSampler,
        length_property='modality_length',
        per_device_batch_size=batch_size * accumulative_counts),
    collate_fn=dict(type=scanvla_collect_fn_COCOSearch18)
)
#######################################################################
