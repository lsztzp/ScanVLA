...
class ScanVLAModel(BaseModel):
    def __init__(self,
        ...
        # path = "/data/lyt/03-Repositories/01-ours/ScanVLA/ScanHisVLA/work_dirs/ScanHisVLA_TP_ZeroGaze_car_LLM_froze/iter_36736.pth"
    ...
    def calc_xyt_token_loss(self, x_mu, y_mu, t_mu, token_predict, data):
        ...
        # return loss_x, loss_y, loss_t, loss_token, loss_dtw 
    ...
    def forward(self, data, data_samples=None, mode='loss'):
        ...
        t_mu = self.activation_time(self.generator_t_mu(outs)).flatten()
        ...
        # loss_x, loss_y, loss_t, loss_token, loss_dtw = self.calc_xyt_token_loss(x_mu, y_mu, t_mu, token_predict, data)
