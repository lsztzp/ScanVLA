...
def get_args_parser_pretrain():
    ...
    parser.add_argument('--img_dir', default='/data/lyt/01-Datasets/01-ScanPath-Datasets/ART_data/data/images_512X320/', type=str) #1
...
def get_args_parser_train():
    ...
    # parser.add_argument('--train_file', default='refcocogaze_train_tf_512X320_6.json', type=str)
    parser.add_argument('--val_file', default= 'refcocogaze_val_correct_tf_512X320_6.json', type=str)
    # parser.add_argument('--val_file', default='refcocogaze_val_tf_512X320_6.json', type=str)

    parser.add_argument('--test_file', default='refcocogaze_test_correct_512X320.json', type=str)  # 1
    ...
    parser.add_argument('--cat_dict_file', default='/data/lyt/01-Datasets/01-ScanPath-Datasets/ART_data/data/catDict.pkl', type=str)
    ...
    parser.add_argument('--vgcore_model_checkpoint', default='./checkpoints/vgcore_checkpoint.pkg', type=str)
    ...
    parser.add_argument("--work_dir", default="Baseline", type=str, help="log_dir")  # 1
    parser.add_argument('--cuda', default=0, type=int, help="CUDA core to load models and data")
    parser.add_argument('--num_samples', default=1, type=int, help='Number of scanpaths to sample for each cae')
