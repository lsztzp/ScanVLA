...
def get_metrics(predictions):
    ...
    clusters = np.load('/data/lyt/01-Datasets/01-ScanPath-Datasets/ART_data/data/clusters_refcocogaze.npy', allow_pickle=True).item()
    gt = pickle.load(open('/data/lyt/01-Datasets/01-ScanPath-Datasets/ART_data/data/refcocogaze_test_synced.pkl', mode='rb'))
