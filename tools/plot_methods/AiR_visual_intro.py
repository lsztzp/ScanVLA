...
if __name__ == '__main__':
    ...
    for question_id, performance, idx, scanpath, img_name, question in tqdm(scanpaths):
        ...
        # [Y,X]
        scanpath = np.array([[0.41601562, 0.46609375],
       [0.48359375, 0.5078125 ],
       [0.42742188, 0.65234375],
       [0.398125  , 0.74484375],
       [0.37245312, 0.758375  ],
       [0.36264062, 0.763046875],
       [0.31046875 , 0.76065625],
       [0.25664062, 0.7503125  ],
       [0.246875 , 0.747140625],
       [0.23046875 , 0.7453125 ]])
        image_path = "/data/lyt/03-Repositories/01-ours/ScanVLA/ScanVLA-main/tools/plot/intro/45775.jpg"
        save_path = "/data/lyt/03-Repositories/01-ours/ScanVLA/ScanVLA-main/tools/plot/intro/AiR/45775_AiR.jpg"
